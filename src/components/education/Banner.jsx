...
import banner1 from '../../assets/images/awareness banner1.jpg';
import banner2 from '../../assets/images/awareness banner1.jpg';
import banner3 from '../../assets/images/awareness banner1.jpg';
const Banner = () => {
    return (
       <div className="">
        <Swiper 
